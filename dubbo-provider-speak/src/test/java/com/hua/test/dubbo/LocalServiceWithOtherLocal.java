/**
 * 描述: 
 * LocalServiceWithOtherLocal.java
 * 
 * @author qye.zheng
 *  version 1.0
 */
...
public final class LocalServiceWithOtherLocal extends BaseTest {

	
	/*
	 * 以接口形式，调用本地服务，本地服务调用本地其他服务
	 * 直接调用即可.
	 * 
	 * debug 断点也是进入接口的实现类.
	 * 
	...
	public void testInvokeLocalService() {
		try {
			ResultBean resultBean = speakService.sayWithTalk("你好吗，哈哈啊");
